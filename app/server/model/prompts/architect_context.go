...
3. Output Context Sections
   ...
   - State "No context needs to be loaded." along with a brief conversational response and output <Gpt4cliFinish/>
   ...
   c) Output <Gpt4cliFinish/> immediately after

CRITICAL RULES:
- Do NOT write any code or implementation details
- Do NOT create tasks or plans
- Stop immediately after <Gpt4cliFinish/>
...
`
  ...
  4. If you already have enough information from the project map to make a detailed plan or respond effectively to the user and so you won't need to load any additional context, then skip step 5 and output a <Gpt4cliFinish/> immediately after steps 1 and 2 above.
  ...
  5. Otherwise, you MUST output:
     ...
     c) Immediately after the '### Files' list, output a <Gpt4cliFinish/> tag. ***Do not output any text after <Gpt4cliFinish/>.***
