...
- _apply.sh:
<Gpt4cliBlock lang="bash" path="_apply.sh">
# Code goes here
</Gpt4cliBlock>
...
- There must be NO lines between the file path and opening <Gpt4cliBlock> tag
- Use lang="bash" in the <Gpt4cliBlock> tag

When writing to _apply.sh include an ### Action Explanation Format section, a file path label, and a <Gpt4cliBlock> tag that includes both a 'lang' attribute and a 'path' attribute as described in the instructions above.
...
- Follow ALL instructions for *creating a new file* with an ### Action Explanation Format section, a file path label, and a <Gpt4cliBlock> tag that includes both a 'lang' attribute and a 'path' attribute as described in the instructions above.
...
- Follow ALL instructions for *updating an existing file* with an ### Action Explanation Format section, a file path label, and a <Gpt4cliBlock> tag that includes both a 'lang' attribute and a 'path' attribute as described in the instructions above.
...
- ALWAYS use <Gpt4cliBlock lang="bash"> tags
